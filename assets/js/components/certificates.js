/* صفحة الشهادات — ميزة قيد التطوير (Demo)، بلا إصدار شهادات فعلي. */
(function (global) {
  'use strict';
  ...
  function render() {
    return '<div class="wrap">' +
      DLP.layout.breadcrumbs([{ label: t('nav.home'), href: '#/' }, { label: t('nav.certificates') }]) +
      '<section class="subject-hero" style="margin-top:14px">' +
        '<h1>🎓 ' + esc(t('nav.certificates')) + '</h1>' +
        '<p>' + esc(t('certificates.intro')) + '</p>' +
      ...
      '<div class="soon-card">' +
        ...
        '<h2>' + esc(t('nav.certificates')) + ' — ' + esc(t('common.comingSoon')) + '</h2>' +
  ...
  DLP.certificatesView = { render: render };
